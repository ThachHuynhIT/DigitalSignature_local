                ...
                <form action="">
                    <div class="card-body">
                      ...
                      <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain
                        was born and I will give you a complete account of the system, and expound on the actual teachings
                    ...
                    <div class="card-footer border">
                        <button name="sign-btn" type="button" class="btn btn-block btn-secondary btn-lg width-full"><i class="fas fa-lock"></i>
                            SIGN</button>
                    </div>
                </form>
                <!-- /.card-footer -->
